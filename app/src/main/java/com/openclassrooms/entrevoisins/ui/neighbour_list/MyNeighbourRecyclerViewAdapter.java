...
public class MyNeighbourRecyclerViewAdapter extends RecyclerView.Adapter<MyNeighbourRecyclerViewAdapter.ViewHolder> {
    ...
    public MyNeighbourRecyclerViewAdapter(List<Neighbour> items, NeighbourListener neighbourListener, Context context) {
        mNeighbours = items;
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private NeighbourListener neighbourListener;


        private ViewHolder(View view, NeighbourListener neighbourListener) {
            super(view);
        ...
        public void onClick(View v) {
            ...
            neighbourListener.onClickItemNeighbour(getAdapterPosition());
        }
